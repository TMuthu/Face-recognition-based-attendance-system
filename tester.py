...
test_img=cv2.imread('T:/B.E/Mini Project/Mini Project IV/Final/TestImages/test.jpg')#test_img path
...
#faces,faceID=fr.labels_for_training_data('E:/Mini Project IV/Final/Training Images')
#face_recognizer=fr.train_classifier(faces,faceID)
#face_recognizer.save('trainingData.yml')
face_recognizer=cv2.face.LBPHFaceRecognizer_create()
face_recognizer.read('trainingData.yml')#use this to load training data for subsequent runs

name={1:"Muthu",2:"Vijay"}#creating dictionary containing names for each label
